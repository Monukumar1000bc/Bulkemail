...
if(isset($_POST['email_data']))
{
 ...
 foreach($_POST['email_data'] as $row)
 {
  ...
  $mail->From = 'monu@cozyvision.com';   //Sets the From email address for the message
  $mail->FromName = '1000BC';     //Sets the From name of the message
  $mail->AddAddress($row["email"], $row["status"]); //Adds a "To" address
